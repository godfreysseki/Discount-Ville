		...
		<section class="content">
            ...
            <?php
              ...
              if (isset($_POST['btnimg']) && $_SERVER['REQUEST_METHOD'] === 'POST') {
                $changeImg = new Users();
                echo $changeImg->updatepicture(basename($_FILES['profimg']['name']), $_FILES["profimg"]["tmp_name"]);
              }
            ...
            ?>
					...
					<div class="col-md-3">
						...
						<div class="card card-primary card-outline">
							<div class="card-body box-profile">
								<img src="../assets/img/users/<?= $data->userProfilePic($_SESSION['user_id']) ?>" class="rounded shadow" alt="user image" width="100%">
                ...
                ?>
								...
								<p class="text-muted"><?= phone($items['phone']) ?></p>
								<hr>
						...
						<div class="card">
							<div class="card-header p-2">
								<ul class="nav nav-pills">
									...
									<li class="nav-item"><a class="nav-link" href="#password" data-toggle="tab">Update Profile Pic / Password</a></li>
								</ul>
							</div><!-- /.card-header -->
							<div class="card-body">
                    ...
                    ?>
                        ...
                        <?php foreach ($trails as $trail) : ?>
													<tr>
														...
														<td><?= ($trail['details']); ?></td>
														<td><?= nl2br(($trail['old_value'])); ?></td>
														<td><?= nl2br(($trail['new_value'])); ?></td>
