...
?>
	...
	<main class="main secondHandProducts">
		<nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
			<div class="container">
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href=./>Home</a></li>
					<li class="breadcrumb-item"><a href="shop.php">Shop</a></li>
					<li class="breadcrumb-item active">Second Hand Products</li>
				</ol>
			</div><!-- End .container -->
				...
				<div class="row">
                  ...
                  <a href="category-4cols.html" class="btn-layout active">
                    <svg width="22" height="10">
                      ...
                      <rect x="18" y="6" width="4" height="4"/>
						...
						<div class="products mb-3">
							<div class="secondHandListings row justify-content-center">
					...
					<aside class="col-lg-3 order-lg-first">
                      ...
                      <?= $data->generateAllSecondHandCategoryFilter() ?>
